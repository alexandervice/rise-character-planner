    ...
    <div className='dark:bg-zinc-800 bg-slate-400 rounded py-5'>
      ...
      <div className="flex  flex-wrap justify-center p-5">
        ...
        {allRaces.map((race, index) => (
            <div key={index} className={`m-4 pt-5  ${characterData && characterData.race._id === race._id ? 'border-4 border-blue-600 dark:border-yellow-600' : ''} `} onClick={() => handleRaceSelection(race)} onMouseEnter={() => setHovered(race)} onMouseLeave={() => setHovered(null)}>
