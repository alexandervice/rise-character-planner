    ...
    <div className='bg-zinc-800 rounded py-5'>
      ...
      <div className="flex  flex-wrap justify-center py-5">
        ...
        {allRaces.map((race, index) => (
            <div key={index} className={`m-4 pt-5  ${characterData && characterData.race._id === race._id ? 'border-4 border-blue-500' : ''} `} onClick={() => handleRaceSelection(race)} onMouseEnter={() => setHovered(race)} onMouseLeave={() => setHovered(null)}>
